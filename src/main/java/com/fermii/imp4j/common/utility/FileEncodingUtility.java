...
public class FileEncodingUtility {
     ...
     * @return charset
     */
    public static String getFileCharset(InputStream fileInputStream) {
        String charset = "GBK";
        byte[] first3Bytes = new byte[3];
        try {
            boolean checked = false;
            InputStream newFileInputStream = cloneInputStream(fileInputStream);
     ...
     * @return byte[]
     */
    public static byte[] getFileByte(FileInputStream fileInputStream) {
        try {
            ByteArrayOutputStream baos = new ByteArrayOutputStream();
            byte[] buffer = new byte[1024];
            int len;
